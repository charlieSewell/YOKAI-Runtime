...
void CharliePhysics::PhysicsTest1()
{
	...
	m_objectManager.GetObject(Ball)->GetComponent<SphereCollider>()->SetMass(4.0);
...
void CharliePhysics::Init()
{
	...
	Wall = m_objectManager.CreateObject("Wall");
	m_objectManager.GetObject(Wall)->AddComponent<DrawableEntity>()->LoadModel("content/demoScene/models/LectureTheatre/Desk/gridwall.gltf");
	m_objectManager.GetObject(Wall)->AddComponent<Transform>()->SetPosition(glm::dvec3(12.125, -0.8, -10));
	m_objectManager.GetObject(Wall)->Start();
	m_objectManager.GetObject(Wall)->GetComponent<Transform>()->SetScale(10);
	...
	m_objectManager.GetObject(Ball)->AddComponent<Transform>()->SetPosition(glm::dvec3(14, 2.75, -4.0));
