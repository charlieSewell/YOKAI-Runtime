...
void DemoScene::Init() 
{
	...
	*/
	...
	m_objectManager.GetObject(Plank1)->AddComponent<Transform>()->setPosition(glm::dvec3(12.5, 2.5, -4));
	...
	*/
	...
	//m_objectManager.GetObject(Plank2)->GetComponent<SphereCollider>()->SetGravityAffected(true);
}
